...
MODEL.SPECIFIC.PARMS <- list(verbose=0,num.trees=1000) #NULL # Other model specific parameters
...
L1FeatureSet$train$predictors <- data.frame(gbm_yhat,xgb_yhat,rngr_yhat)
