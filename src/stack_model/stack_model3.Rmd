...
ggplot() +
  ...
  geom_text(aes(x=3.25,y=2.5,label="nnet")) +
    
  geom_rect(aes(xmin=1.25,ymin=2,xmax=2.25,ymax=3,fill="Level 1")) +
  geom_text(aes(x=1.75,y=2.5,label="gbm")) +
  ...
  geom_text(aes(x=2.5,y=0.25,label="Final Prediction",fontface="bold")) +
...
### Neural Net Model
Public Leaderboard Score:  `r filter(plb_data,Model=="L1nnet")$PLB_Score`
```{r trainL1nnet}
# set caret training parameters
...
### gbm Model
Public Leaderboard Score:  `r filter(plb_data,Model=="l1gbm")$PLB_Score`
```{r trainL1gbm}
# set caret training parameters
CARET.TRAIN.PARMS <- list(method="gbm") 
