...
This document is an R port of [Alexandru Papiu](https://www.kaggle.com/apapiu)'s 
excellent [Jupyter-Notebook Kernel]
(https://www.kaggle.com/apapiu/house-prices-advanced-regression-techniques/regularized-linear-models) for the 
House Price competition.

I've structured this document to mirror Alexandru's jupyter-notebook.  The R code chunks 
are labeled the same as the Python code chunks found in [Version 17](https://www.kaggle.com/apapiu/house-prices-advanced-regression-techniques/regularized-linear-models/run/373120) of his
document.
...
cat("Lasso picked",picked_features,"variablaes and eliminated the other",
